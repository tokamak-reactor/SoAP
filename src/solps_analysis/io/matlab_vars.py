...
def n_species(watch) -> int:
    ...
    try:
        ...
        # structured files: "nx,ny,ns"; unstructured: "nCv,nFc,ns"
        dim = raw.get("nx,ny,ns")
        if dim is None:
            dim = raw.get("nCv,nFc,ns")
...
_FACE_SPECIES_VARS: dict[str, tuple] = {
    "fna_mdf_th": (["b2npc11_fnax", "b2npc9_fnax", "b2npc7_fnax", "b2npco_fnax", "b2tfnb_fnb_mdfx", "b2npco_fna_mdf_th"], 1, 1.0),
    "fna_mdf_r":  (["b2npc11_fnay", "b2npc9_fnay", "b2npc7_fnay", "b2npco_fnay", "b2tfnb_fnb_mdfy", "b2npco_fna_mdf_r"], 2, 1.0),
    "fna_th":     (["b2tfnb_fnbx", "b2npc11_fnax", "b2npco_fna_th", "b2tfnb_fnb_th"], 1, 1.0),
    "fna_r":      (["b2tfnb_fnby", "b2npc11_fnay", "b2npco_fna_r", "b2tfnb_fnb_r"], 2, 1.0),
    "fna_nupar_th": (["b2tfnb_bxuanax", "b2tfnb_bxuana_th"], 1, 1.0),
    "fna_nuBgradB_th": (["b2tfnb_vadianax", "b2tfnb_vadiana_th"], 1, 1.0),
    "fna_nuBgradB_r":  (["b2tfnb_vadianay", "b2tfnb_vadiana_r"], 2, 1.0),
    "fna_nuExB_th": (["b2tfnb_vaecrbnax", "b2tfnb_vaecrbna_th"], 1, 1.0),
    "fna_nuExB_r":  (["b2tfnb_vaecrbnay", "b2tfnb_vaecrbna_r"], 2, 1.0),
    "fna_dia_mdf_th": (["b2tfnb_fnbPSchx", "b2tfnb_fnbPSch_th"], 1, -1.0),
    "fna_dia_mdf_r":  (["b2tfnb_fnbPSchy", "b2tfnb_fnbPSch_r"], 2, -1.0),
    "fna_nuAN_r":   (["b2tfnb_cvlbnay", "b2tfnb_cvlbna_r"], 2, 1.0),
    "fna_RhieChow_th": (["b2tfnb_dpccornax", "b2tfnb_dpccorna_th"], 1, 1.0),
    "fna_Dgradn_th": (["b2tfnb_dPat_mdf_gradnax"], 1, 1.0),
    "fna_Dgradn_r":  (["b2tfnb_dPat_mdf_gradnay"], 2, 1.0),
    "fna_fha_th":   (["b2tfnb_fnb_hex", "b2tfnb_fnb_he_th"], 1, 1.0),
    "fna_fha_r":    (["b2tfnb_fnb_hey", "b2tfnb_fnb_he_r"], 2, 1.0),
    "fna_flo_th":   (["b2tfnb_fnb_32x", "b2tfnb_fnb_32_th"], 1, 1.0),
    "fna_flo_r":    (["b2tfnb_fnb_32y", "b2tfnb_fnb_32_r"], 2, 1.0),
    "fna_mo_th":    (["b2tfnb_fnb_fcorx", "b2tfnb_fnb_fcor_th"], 1, 1.0),
    "fna_mo_r":     (["b2tfnb_fnb_fcory", "b2tfnb_fnb_fcor_r"], 2, 1.0),
    ...
    "fch_AN_th":    (["b2tfch_fchanml_ax", "b2tfnb_fchanml_bx", "b2tfch_fchanml_th"], 1, 1.0),
    "fch_AN_r":     (["b2tfch_fchanml_ay", "b2tfnb_fchanml_by", "b2tfch_fchanml_r"], 2, 1.0),
    "fch_inert_th": (["b2tfch_fchinert_ax", "b2tfnb_fchinert_bx", "b2tfch_fchinert_th"], 1, 1.0),
    "fch_inert_r":  (["b2tfch_fchinert_ay", "b2tfnb_fchinert_by", "b2tfch_fchinert_r"], 2, 1.0),
    "fch_vispar_th": (["b2tfch_fchvispar_ax", "b2tfnb_fchvispar_bx", "b2tfch_fchvispar_th"], 1, 1.0),
    "fch_vispar_r":  (["b2tfch_fchvispar_ay", "b2tfnb_fchvispar_by", "b2tfch_fchvispar_r"], 2, 1.0),
    "fch_visper_th": (["b2tfch_fchvisper_ax", "b2tfnb_fchvisper_bx", "b2tfch_fchvisper_th"], 1, 1.0),
    "fch_visper_r":  (["b2tfch_fchvisper_ay", "b2tfnb_fchvisper_by", "b2tfch_fchvisper_r"], 2, 1.0),
    "fch_visq_th":  (["b2tfch_fchvisq_ax", "b2tfnb_fchvisq_bx", "b2tfch_fchvisq_th"], 1, 1.0),
    "fch_visq_r":   (["b2tfch_fchvisq_ay", "b2tfnb_fchvisq_by", "b2tfch_fchvisq_r"], 2, 1.0),
    "fch_in_th":    (["b2tfch_fchin_ax", "b2tfnb_fchin_bx", "b2tfch_fchin_th"], 1, 1.0),
    "fch_in_r":     (["b2tfch_fchin_ay", "b2tfnb_fchin_by", "b2tfch_fchin_r"], 2, 1.0),
    "vel_ExB_th":   (["b2tfnb_vbecrbx", "b2tfnb_vbecrb_th"], 1, 1.0),
    "vel_ExB_r":    (["b2tfnb_vbecrby", "b2tfnb_vbecrb_r"], 2, 1.0),
...
_CELL_SPECIES_VARS: dict[str, tuple] = {
    ...
    "vel_BgradB_th": (["b2tfnb_vbdiax", "b2tfnb_vbdia_th"], 1.0),
    "vel_BgradB_r":  (["b2tfnb_vbdiay", "b2tfnb_vbdia_r"], 1.0),
    "vel_dia_th": (["b2tfnb_wbdiax", "b2tfnb_wbdia_th"], 1.0),
    "vel_dia_r":  (["b2tfnb_wbdiay", "b2tfnb_wbdia_r"], 1.0),
...
_FACE_SCALAR_VARS: dict[str, tuple] = {
    "fch_th": (["b2npp7_fchx", "b2nppo_fch_th", "b2tfch_fch_th"], 1, 1.0, None),
    "fch_r":  (["b2npp7_fchy", "b2nppo_fch_r", "b2tfch_fch_r"], 2, 1.0, None),
    "fch_par_th": (["b2tfch_fch_px", "b2tfch_fch_p_th"], 1, 1.0, None),
    "fch_nuBgradB_th": (["b2tfch_fchdiax", "b2tfch_fchdia_th"], 1, 1.0, None),
    "fch_nuBgradB_r":  (["b2tfch_fchdiay", "b2tfch_fchdia_r"], 2, 1.0, None),
    "fch_stoch_r": (["b2tfch_fchstochy", "b2tfch_fchstoch_r"], 2, 1.0, None),
    "fhe_mdf_th": (["b2nph9_fhex", "b2tfhe_fhe_mdf_th"], 1, 1.0, None),
    "fhe_mdf_r":  (["b2nph9_fhey", "b2tfhe_fhe_mdf_r"], 2, 1.0, None),
    "fhi_mdf_th": (["b2nph9_fhix", "b2tfhi_fhi_mdf_th"], 1, 1.0, None),
    "fhi_mdf_r":  (["b2nph9_fhiy", "b2tfhi_fhi_mdf_r"], 2, 1.0, None),
    "fhe_th": (["b2tfhe_fhe_no_mdfx", "b2tfhe_fhe_no_mdf_th", "b2npht_fhe_th"], 1, 1.0, None),
    "fhe_r":  (["b2tfhe_fhe_no_mdfy", "b2tfhe_fhe_no_mdf_r", "b2npht_fhe_r"], 2, 1.0, None),
    "fhi_th": (["b2tfhe_fhi_no_mdfx", "b2npht_fhi_th"], 1, 1.0, None),
    "fhi_r":  (["b2tfhe_fhi_no_mdfy", "b2npht_fhi_r"], 2, 1.0, None),
    "fhe_dia_mdf_th": (["b2tfhe_fhePSchx", "b2tfhe_fhePSch_th"], 1, -1.0, None),
    "fhe_dia_mdf_r":  (["b2tfhe_fhePSchy", "b2tfhe_fhePSch_r"], 2, -1.0, None),
    "fhi_dia_mdf_th": (["b2tfhi_fhiPSchx", "b2tfhi_fhiPSch_th"], 1, -1.0, None),
    "fhi_dia_mdf_r":  (["b2tfhi_fhiPSchy", "b2tfhi_fhiPSch_r"], 2, -1.0, None),
...
_CELL_SCALAR_VARS: dict[str, tuple] = {
    "te": (["b2nph9_te", "b2nph9_te_inp", "b2npht_te"], 1.0),
    "ti": (["b2nph9_ti", "b2nph9_ti_inp", "b2npht_ti"], 1.0),
    "ne": (["ne", "b2tfhe_ne"], 1.0),
    "po": (["b2npp7_po", "b2nppo_po", "b2tfhe_po"], 1.0),
    "ue": (["b2npmo_ue"], 1.0),
    "Zeff": (["Zeff"], 1.0),
    ...
    "she": (["b2nph9_she", "b2npht_she"], 1.0),
    "shi": (["b2nph9_shi", "b2npht_shi"], 1.0),
    "she_ei": (["b2nph9_shei", "b2npht_shei"], 1.0),
